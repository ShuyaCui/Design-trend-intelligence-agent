...
from trend_agent.multi_agent_supervisor import supervisor_agent
from trend_agent.prompts import final_report_generation_prompt
from trend_agent.research_agent_scope import scope_research
